...
import com.tsb.cb.service.Resilience4jProperties.InstanceProperties;
...
public class CircuitBreakerConfigurationProperties extends CommonProperties{
	private static Logger logger = LoggerFactory.getLogger(CircuitBreakerConfigurationProperties.class);
    ...
    @Nullable
    private String predicateExceptions;
    
    public CircuitBreakerConfigurationProperties() {
		// TODO Auto-generated constructor stub
    	System.out.println("CircuitBreaker Properties constructor");
	}

    public Optional<InstanceProperties> findCircuitBreakerProperties(String name) {
    	logger.info("Circuit breaker name from findCircuitBreakerProperties:---"+name);
    	System.out.println("Circuit breaker name from findCircuitBreakerProperties:---"+name);
        InstanceProperties instanceProperties = instances.get(name);
        //System.out.println("Circuit breaker name from findCircuitBreakerProperties instanceProperties:---"+instanceProperties.waitDurationInOpenStateV);
        if (instanceProperties == null) {
        	System.out.println(" instance properties is null");
            instanceProperties = configs.get("default");
        } 
        if(instanceProperties.getSlowCallDurationThreshold()!=null){
            System.out.println(" instanceProperties of "+name+" scdt "+instanceProperties.getSlowCallDurationThreshold().getSeconds());}
        
        logger.info("Circuit breaker name from findCircuitBreakerProperties instanceProperties:---"+instanceProperties.waitDurationInOpenState);
    ...
    public String getPredicateExceptions() {
		return predicateExceptions;
	}

	public void setPredicateExceptions(String predicateExceptions) {
		this.predicateExceptions = predicateExceptions;
	}
    ...
    public static class InstanceProperties {
    	...
    	public InstanceProperties() {
    		...
    		System.out.println("calling INstance Properties constructors....");
		}
		...
		/*
		 * @Nullable private String waitDurationInOpenStateV;
		 */
        ...
        public Class<? extends Throwable>[] getRecordExceptions() {
        	...
        	System.out.println(recordExceptions);
        ...
        public Class<? extends Throwable>[] getIgnoreExceptions() {
        	System.out.println("ignoreExceptions: creating---");
        	System.out.println(ignoreExceptions);
            return ignoreExceptions;
        }

        public InstanceProperties setIgnoreExceptions(
            Class<? extends Throwable>[] ignoreExceptions) {
        	System.out.println("ignoreExceptions.getClass():---"+ignoreExceptions.getClass().getName());
        ...
        public InstanceProperties setSlowCallDurationThreshold(Duration slowCallDurationThreshold) {
        	System.out.println("setSlowCallRateThreshold in CBCP "+slowCallRateThreshold);
